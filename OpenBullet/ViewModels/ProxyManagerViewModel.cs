...
namespace OpenBullet.ViewModels
{
    public class ProxyManagerViewModel : ViewModelBase, IProxyManager, IProxyChecker
    {
        ...
        public string TestSite { get { return SB.Settings.ProxyManagerSettings.ActiveProxySiteUrl; } set { SB.Settings.ProxyManagerSettings.ActiveProxySiteUrl = value; OnPropertyChanged(); } }

        public string SuccessKey { get { return SB.Settings.ProxyManagerSettings.ActiveProxyKey; } set { SB.Settings.ProxyManagerSettings.ActiveProxyKey = value; OnPropertyChanged(); } }
