...
namespace ImageProcessor
{
    ...
    public class ImageFactory : IDisposable
    {
        ...
        public ImageFactory Pixelate(int pixelSize/*, Rectangle? rectangle = null*/)
        {
            ...
            {
                var pixelate = new Pixelate { DynamicParameter = new Tuple<int, Rectangle?>(pixelSize, null) };
        ...
        public ImageFactory ResizeEx(Size size)
        {
            if (ShouldProcess)
            {
                var resize = new ResizeEx() { DynamicParameter = size };
        ...
        public ImageFactory ContrastEx(sbyte threshold)
        {
            if (this.ShouldProcess)
            {
                ...
                var contrastEx = new ContrastEx() { DynamicParameter = threshold };
        ...
        public ImageFactory Blur(int nWeight)
        {
            if (ShouldProcess)
            {
                var blur = new Blur() { DynamicParameter = nWeight };
        ...
        public ImageFactory Atomization()
        {
            if (ShouldProcess)
            {
                var atomization = new Atomization();
        ...
        public ImageFactory RemoveBackground()
        {
            if (ShouldProcess)
            {
                var makeTransparent = new MakeTransparent();
        ...
        public ImageFactory Mean(int value)
        {
            if (ShouldProcess)
            {
                var mean = new Mean() { DynamicParameter = value };
        ...
        public ImageFactory Smooth(int value)
        {
            if (ShouldProcess)
            {
                var smooth = new Smooth() { DynamicParameter = value };
        ...
        public ImageFactory Threshold(int value)
        {
            if (ShouldProcess)
            {
                var threshold = new ColorThreshold() { DynamicParameter = value };
                backupFormat.ApplyProcessor(threshold.ProcessImage, this);
                return this;
            }
            return this;
        }
        ...
        public ImageFactory ThresholdEx(ThresholdLayer layer)
        {
            if (ShouldProcess)
            {
                var thresholdEx = new ThresholdEx() { DynamicParameter = layer };
        ...
        public ImageFactory Zoom(ZoomLayer zoomLayer)
        {
            if (ShouldProcess)
            {
                var zoom = new Zoom() { DynamicParameter = zoomLayer };
        ...
        public ImageFactory Median(int ksize)
        {
            if (ShouldProcess)
            {
                var median = new Median() { DynamicParameter = ksize };
        ...
        public ImageFactory MorphologyEx(MorphologyLayer layer)
        {
            if (ShouldProcess)
            {
                var morphologyEx = new MorphologyEx() { DynamicParameter = layer };
        ...
        public ImageFactory AdaptiveThreshold(AdaptiveThresholdLayer layer)
        {
            if (ShouldProcess)
            {
                var adaptiveThreshold = new AdaptiveThreshold() { DynamicParameter = layer };
        ...
        public ImageFactory Alignment(int n)
        {
            if (ShouldProcess)
            {
                var alignment = new Alignment() { DynamicParameter = n };
        ...
        public ImageFactory FastNlMeansDenoisingColored(FastNlMeansDenoisingColoredLayer layer)
        {
            if (ShouldProcess)
            {
                var fastNlMeansDenoisingColored = new FastNlMeansDenoisingColored() { DynamicParameter = layer };
