                ...
                switch (data.GlobalSettings.Selenium.Browser)
                {
                    case BrowserType.Chrome:
                        try
                        {
                            ...
                            if (data.ConfigSettings.DefaultProfileDirectory) chromeop.AddArgument("--profile-directory=Default");
                            ...
                            if (data.GlobalSettings.Selenium.FastStart) { chromeop.AddArgument("--fast-start"); }
                    ...
                    case BrowserType.Firefox:
                        try
                        {
                            ...
                            if (data.ConfigSettings.DefaultProfileDirectory) fireop.AddArgument("--profile-directory=Default");
                            ...
                            if (data.GlobalSettings.Selenium.FastStart) { fireop.AddArgument("--fast-start"); }
                            if (data.GlobalSettings.Selenium.DisableAutomation)
                            {
