...
namespace RuriLib
{
    ...
    public class BlockParse : BlockBase
    {
        ...
        /// index output list 
        /// </summary>
        public int IndexOutputList { get { return indexOutputList; } set { indexOutputList = value; OnPropertyChanged(); } }
        ...
        public override BlockBase FromLS(string line)
        {
            ...
            switch (Type)
            {
                ...
                case ParseType.REGEX:
                    ...
                    var tmpInp = input;
                    try { IndexOutputList = LineParser.ParseInt(ref input, "INDEX"); } catch { input = tmpInp; }
                    while (LineParser.Lookahead(ref input) == TokenType.Boolean)
                        LineParser.SetBool(ref input, this);
                    break;
            }
