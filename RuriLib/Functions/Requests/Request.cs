...
namespace RuriLib.Functions.Requests
{
    ...
    public class Request
    {
        ...
        /// <param name="method">The HTTP method</param>
        /// <param name="log">The log (if any)</param>
        /// <param name="resToMemoryStream">response to memory stream</param>
        /// <returns>A 4-tuple containing Address, Response code, Headers and Cookies.</returns>
        public (string, string, Dictionary<string, string>, Dictionary<string, string>) Perform(string url, HttpMethod method, List<LogEntry> log = null, bool resToMemoryStream = false)
        {
            var address = "";
            var responseCode = "0";
            ...
            try
            {
                ...
                {
                    memoryStream = response.ToMemoryStream();
                }
        ...
        {
            var source = "";
            var responseString = memoryStream == null ? response.ToString() : GetSourceFromStream();
        ...
        /// <summary>
        /// Reads the response to a string
        /// </summary>
        /// <returns></returns>
